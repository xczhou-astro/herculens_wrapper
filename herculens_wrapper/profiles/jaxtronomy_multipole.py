...
class LensProfileBase:
    """Minimal compatibility base; Herculens consumes the profile methods directly."""
    pass
...
class _ParamUtil:
    ...
    def cart2polar(x, y, center_x=0, center_y=0):
        ...
        return jnp.hypot(x_shifted, y_shifted), jnp.arctan2(y_shifted, x_shifted)

param_util = _ParamUtil()
