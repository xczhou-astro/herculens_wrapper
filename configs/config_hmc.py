...
def arguments():
    ...
    args = {
        ...
        'use_source_support_mask_hmc': True,
        ...
        'init_params_path': '../modeling_F277W/svi/run_1',
        'refine_prior_range': None,
        'refine_prior_min_frac': None,
        'pixel_init_jitter': 0.0,
        'fix_component': ['lens_light'],  # list of components to fix: 'lens_mass' | 'lens_light' | 'source_light'
        'regul_num_samples': 1000,
        'gpus': '7',
        'n_runs': 1,

        'num_warmup_hmc_numpyro': 2000,
